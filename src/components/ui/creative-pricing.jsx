...
function CreativePricing({
    ...
    return (
        <section className="py-24 bg-zinc-950 relative overflow-hidden border-t border-white/5" id="pricing">
            {/* Background Glows */}
            <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-indigo-900/10 rounded-full mix-blend-screen filter blur-[120px] opacity-30 translate-x-1/2 -translate-y-1/2 pointer-events-none" />
            <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-[#D4AF37]/10 rounded-full mix-blend-screen filter blur-[100px] opacity-20 -translate-x-1/3 translate-y-1/3 pointer-events-none" />
            ...
            <div className="w-full max-w-7xl mx-auto px-6 md:px-12 relative z-10">
                <div className="text-center space-y-6 mb-20">
                    ...
                    <motion.p
                        ...
                        className="font-sans text-lg md:text-xl text-zinc-400 max-w-2xl mx-auto"
                    >
                        {description}
                    </motion.p>
                </div>
                        ...
                        >
                            ...
                            <div
                                className={cn(
                                    ...
                                    "group-hover:bg-white/10 group-hover:-translate-y-2",
                                    tier.popular ? "border-[#D4AF37]/40 shadow-[0_0_40px_rgba(212,175,55,0.15)] group-hover:border-[#D4AF37]/60" : "shadow-xl"
                                )}
                            >
                                ...
                                <div className="mb-8 relative z-10 flex-1">
                                    <div
                                        className={cn(
                                            ...
                                            tier.popular
                                                ...
                                                : "bg-white/5 border-white/20 text-zinc-300 group-hover:text-white"
                                        )}
                                    >
                                        {tier.icon}
                                    </div>
                                    ...
                                    <p className="font-sans text-zinc-400 text-sm leading-relaxed mb-6">
                                        {tier.description}
                                    </p>

                                    {/* Price */}
                                    <div className="font-sans flex items-baseline gap-2 mb-8 pb-8 border-b border-white/10">
                                    ...
                                    <div className="space-y-4 font-sans">
                                        {tier.features.map((feature, i) => (
                                            <div key={i} className="flex items-start gap-4">
                                                <div className="mt-1 flex-shrink-0 w-5 h-5 rounded-full bg-[#D4AF37]/10 flex items-center justify-center">
                                ...
                                <div className="mt-auto relative z-10 pt-4">
                                    <button
                                        className={cn(
                                            ...
                                            tier.popular
                                                ? "bg-[#D4AF37] text-zinc-950 hover:bg-white hover:text-zinc-950"
                                                : "bg-white/10 text-white hover:bg-[#D4AF37] hover:text-zinc-950 border border-white/20"
                                        )}
                                    >
                                        Choose {tier.name}
                                    </button>
